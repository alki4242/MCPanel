...
public class manager{
    ...
    public void initalize() {
        ...
        if (f.exists()) {
            ...
            // JButton skriptac = new JButton("Deneme");
            // skriptac.setBounds(500, 156, 80, 20);
            // panel.add(skriptac);
            // JPopupMenu skriptm = new JPopupMenu("s");
            // skriptac.addActionListener(new ActionListener() {
            // public void actionPerformed(ActionEvent e) {
            // skriptm.setBounds(100, 130, 500, 600);
            // skriptm.setVisible(true);
            // panel.add(skriptm);
            // }
            // });
            // Açma-Kapama
            ...
            start.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    if (bat.exists()) {
                        ...
                        JOptionPane.showMessageDialog(pencere,
                                "Lutfen JVM argumentlerini calistirmadan once kaydediniz!");
                    }
            ...
            restart.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    JOptionPane.showMessageDialog(pencere,
                            "Yeniden Baslatildi Konsolu kontrol ediniz!");
                }
            });
            ...
            kaydet.setBounds(500, 610, 80, 40);
            pencere.add(kaydet);
            ...
            JOptionPane.showMessageDialog(pencere,
                    "server.properties dosyasi bulunamadi. \n Programin calismasi"
                            + " icin lutfen server.properties dosyas�n� olusturtunuz");
            System.exit(0);
        }
    }
